...
namespace yg331 {
	...
	//  lunchboxController
	//------------------------------------------------------------------------
	class lunchboxController : public Steinberg::Vst::EditControllerEx1
	{
	public:
		//------------------------------------------------------------------------
		lunchboxController() = default;
		~lunchboxController() SMTG_OVERRIDE = default;

		// Create function
		static Steinberg::FUnknown* createInstance(void* /*context*/)
		{
			return (Steinberg::Vst::IEditController*)new lunchboxController;
		}
	...
	public:
		...
		Vst::ParamValue getMid() const { return midValue; }
		void setMid(Vst::ParamValue value) { midValue = value; }
